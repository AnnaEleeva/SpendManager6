...
public class Income {
    ...
    public static StringBuilder incomeIns(double x, String y, String username, int user_id) {
        ...
        try {
            ...
            preparedStatement = connect.prepareStatement("INSERT INTO spend (income, description, username,user_id,op_date) values(?, ?, ?,?,CURDATE())");
