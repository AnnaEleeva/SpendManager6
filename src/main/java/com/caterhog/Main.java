        ...
        while ((c = ch.readNum(scan)) != 5) {
            ...
            switch (c) {
                case 1:
                    ...
                    Expense.consumptionIns(a, t, b, data, user_id, user.username);
                    break;
                case 2:
                    System.out.print("Укажите сумму дохода: ");
                    double countIncom = ch.readDouble(scan);
                    scan.nextLine();
                    System.out.print("Укажите источник дохода: ");
                    String sourceIncom = ch.readString(scan);

                    Income.incomeIns(countIncom, sourceIncom,user.username,user_id);
                    break;
                case 3:
